                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                               <form role="form" class="form-horizontal p-t-20" method="POST" action="{{URL::to('/setting')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input disabled="disabled" type="text" class="form-control{{ $errors->has('name') ? ' has-error' : '' }}" id="exampleInputuname3" placeholder="Username" name="name" value="{{Auth::user()->name}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input disabled="disabled" type="email" class="form-control{{ $errors->has('email') ? ' has-error' : '' }}" id="exampleInputEmail3" placeholder="Enter email" name="email" value="{{Auth::user()->email}}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input 
                                                    ...
                                                    ?>
                                                 type="number" class="form-control{{ $errors->has('phone') ? ' has-error' : '' }}" id="exampleInputuname3" placeholder="Phone number" name="phone" value="{{Auth::user()->phone}}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <a  style="color:white;" class="label label-info btn-sm">{{url('/ref/'.Auth::user()->email)}}</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <a href="{{URL::to('/password/change')}}" class="btn btn-primary btn-sm">Change password</a>
                                        </div>
                                    </div>
                                    @endif
