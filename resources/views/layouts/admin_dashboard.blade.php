                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('img/avatar.png')}}" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="{{asset('img/1.jpg')}}" alt="user"></div>
                                            <div class="u-text">
                                    ...
                                    <li><a href="{{URL::to('account')}}"><i class="ti-user"></i> Account</a></li>
                                    <li><a href="{{URL::to('setting')}}"><i class="ti-wallet"></i> Settings</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="active">
                            <a class="has-arrow"  href="{{URL::to('/admin/user')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">All Users </span></a>
                           
                        </li>
                        <li>

                            
                            <a class="has-arrow " href="{{URL::to('/admin/investment')}}" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Investments</span></a>
                            
                        </li>
                        <li class="three-column">
                            <a class="has-arrow" href="{{URL::to('/admin/profit')}}" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Profits</span></a>
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                             Requests <span class="caret"></span>
                                ...
                                <ul class="dropdown-menu">
                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/admin/request/capital')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Capital Requests</span></a>
                           
                                    </li>

                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/admin/request/profit')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Profit Requests</span></a>
                           
                                    </li>

                                    <li>
                            <a class="has-arrow" href="{{URL::to('/admin/request/bonus')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Bonus Requests</span></a>
                        ...
                        <li>
                            <a class="has-arrow " href="{{URL::to('/admin/inbox')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Messages</span></a>
                           
                        </li>
                        <li class="nav-devider"></li>
                        <li class="nav-small-cap"></li>
                        <li class="two-column">
                            <a class="has-arrow " href="{{URL::to('/admin/testimony')}}" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">Testimonies</span></a>
                        ...
                        <li role="presentation" class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                             News <span class="caret"></span>
                                ...
                                <ul class="dropdown-menu">
                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/admin/news')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">View News</span></a>
                           
                                    </li>

                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/admin/news/create')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Create News</span></a>
                         ...
                         <li>
                            <a class="has-arrow " href="{{URL::to('/admin/stats')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Statistics</span></a>
                           
                        </li>

                         <li>
                            <a class="has-arrow " href="{{URL::to('/admin/config')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Config</span></a>
