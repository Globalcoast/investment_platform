...
<body class="fix-header fix-sidebar card-no-border logo-center">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{URL::to('/home')}}">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                           <!-- <img src="{{asset('img/logo-icon.png')}}" alt="Globalcoast" class="dark-logo" />-->
                            <!-- Light Logo icon -->
                        ...
                        <!-- Logo text -->
                        <!--<span>
                         <img src="{{asset('img/logo-text.png')}}" alt="Globalcoast" class="dark-logo" />  
                         <img src="{{asset('img/logo-light-text.png')}}" class="light-logo" alt="Globalcoast" /></span>-->

                         <span style="text-transform: capitalize;color: white;">Globalcoast - {{Auth::user()->name}}</span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow " href="{{URL::to('wallet')}}" aria-expanded="false"><i class="mdi mdi-arrange-send-backward"></i><span class="hide-menu">My Wallet</span></a>
                            
                        </li>

                        
                        <li class="two-column">
                            <a class="has-arrow" href="{{URL::to('transaction')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Trasactions</span></a>
                        ...
                        <li role="presentation" class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                             Testimony <span class="caret"></span>
                                ...
                                <ul class="dropdown-menu">
                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/testimony/view')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">View testimonies</span></a>
                           
                                    </li>

                                    <li >
                                        <a class="has-arrow " href="{{URL::to('/testimony/create')}}" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Create testimonies</span></a>
   ...
   // $res=file_get_contents('http://jsonip.com');
    ...
    //echo $location;
                      ...
                      ?>
                                    <h4 class="m-t-0 text-info">{{Session::get('user_ip')}}</h4></div>
                                
                            </div>
                            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                                <div class="chart-text m-r-10">
                                    <h6 class="m-b-0"><small>LOCATION</small></h6>
                                    <h4 class="m-t-0 text-primary">{{Auth::user()->city}}, {{Auth::user()->country}}</h4></div>
