      ...
      <div class="section-cover-tier mask-black" style="background-image:url('img/items/img-sample2.jpg')">
        <div class="cover-content">
          <div class="title-desc">
            <h2 class="display-4 display-title">Latest News</h2>
          </div>
        </div>
      </div>
...
<ol>
    ...
    <?php $__currentLoopData = $NewsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $News): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li>
              <h3 style="text-transform:;"><?php echo e($News->title); ?></h3>
              <p><a href="<?php echo e(URL::to('/news/view/'.$News->id)); ?>" class="btn btn-outline-white btn-round btn-sm">Continue</a></p>
            </li>
