          ...
          <div class="row">
            <div class="col-12 col-md-6 text-left">
              ...
              <div class="btns-action anim-3">
                <a class="btn btn-outline-white btn-round" href="<?php echo e(route('register')); ?>#registers">
                  Register
                </a>
...
<video poster="/path/to/poster.jpg" autoplay controls style="width:100%;" data-plyr='{ "autoplay": "true"}'>
  <source src="<?php echo e(asset('vid/vid_ad1.mp4')); ?>" type="video/mp4">
  <!-- Captions are optional -->
              ...
              <div class="section-content">
                  <iframe  src="<?php echo e(asset('vid/vid_ad1.mp4')); ?>" frameborder="0" allowfullscreen></iframe>
              </div>-->
            </div>
        ...
        <div class="section-content reduced anim text-center">
          ...
          <div class="title-desc anim-3">
            <p>GlobalCoast is a registered company founded in 1887 which ventured into agriculture as its major offline investment. However, the organization expanded its scope of service to cryptocurrency marketing in 2008 understanding the time to time electronic cycling of the world and also the innovations of smart cities.</p>
              ...
              <a href="<?php echo e(URL::to('/about')); ?>" class="btn btn-outline-white btn-round btn-sm">More</a>
          </div>
              ...
              <div class="images text-center">
                <div class="img-frame-normal">
                  <div class="img-1 shadow">
                    <a href="index-2.html">
                      <img class="img" src="<?php echo e(asset('img/2.jpeg')); ?>" alt="Image">
                    </a>
                  </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      <?php $i=1;?>
                                        ...
                                        <tr>
                                            <td><a href="javascript:void(0)" class="btn-link"><?php echo e($i); ?></a></td>
                                            <td><?php echo e(date('d-m-y h:i', strtotime($Profit->created_at))); ?> </td>
                                            <td><?php echo e($Profit->user->name); ?></td>
                                            <td><?php echo e(number_format($Profit->amount)." ".$Profit->user->currency_type); ?></td>
        ...
        <div class="section-content anim text-center">
          ...
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              ...
              method="POST" action="<?php echo e(route('register')); ?>">
               <?php echo e(csrf_field()); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php if(isset($ReferralDetails)): ?>

                    <?php if(!empty($ReferralDetails)): ?>

                  <div class="form-group<?php echo e($errors->has('ref_name') ? ' has-error' : ''); ?>">


                    <label for="reg-ref_name">Referral name</label>
                    <input id="reg-ref_name" name="ref_name" class="form-control-line form-control-white" type="text" value="<?php echo e($ReferralDetails->name); ?>" />
                  ...
                  <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                    ...
                    <input id="reg-name" name="name" class="form-control-line form-control-white" type="text" value="<?php echo e(old('name')); ?>" />
    ...
    //echo $location;
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    required placeholder="your@email.address" value="<?php echo e(old('email')); ?>" 
                    />
      ...
      <div class="section-wrapper twoside">
        ...
        <div class="section-title text-center ">
          ...
          <div class="title-abs">
            ...
            <p><a href="<?php echo e(URL::to('/testimony/view')); ?>" class="btn btn-outline-white btn-round btn-sm">View all</a></p>
          </div>
        </div>
...
?>
          ...
          <iframe style="width:100%;" src="<?php echo e($implodedLink); ?>" frameborder="0" allowfullscreen></iframe>
       ...
       <!--<video controls poster="" width="350">
        ...
        <img src="<?php echo e(asset('vid/placeholderImage.png')); ?>" style="width:100%;height: 140px">
        ...
        <?php endif; ?>
                  ...
                  <div class="legend text-left pos-abs">
                    <h5><?php echo e($Testimony->user->name); ?></h5>
                    <p class="small"><?php echo e(substr($Testimony->message, 0, 59)); ?>

                   <?php if(strlen($Testimony->message)<=59): ?>
                   <?php echo e('.'); ?>
                   ...
                   <?php else: ?>
                    <a href="<?php echo e(URL::to('/testimony/view')); ?>" class="btn btn-outline-white btn-round btn-sm">Continue</a>
                   <?php endif; ?>
              ...
              <div class="section-content anim text-left">
                ...
                <div class="">
                  <div class="form-container form-container-card">
                    ...
                    <form class="form" method="POST" action="<?php echo e(URL::to('/inbox/create')); ?>" role="form">
                      ...
                      <div class="form-group name">
                        ...
                        <input id="mes-name" name="name" type="text" placeholder="" class="form-control-line<?php echo e($errors->has('name') ? ' has-error' : ''); ?>"
                      ...
                      <div class="form-group email">
                        ...
                        <input id="mes-email" type="email" placeholder="" name="email" class="form-control-line<?php echo e($errors->has('email') ? ' has-error' : ''); ?>"
                      ...
                      <div class="form-group no-border">
                        ...
                        <textarea id="mes-text" placeholder="..." name="message" class="form-control form-control-outline thick<?php echo e($errors->has('message') ? ' has-error' : ''); ?>"
                        required>
    ...
    <div class="section section-list-feature fp-auto-height-responsive " data-section="security">
      ...
      <div class="section-wrapper twoside anim">
        ...
        <div class="item row  fade-1">
          <span>
            <img src="<?php echo e(asset('img/bc.png')); ?>" width="50px" style="float: left;">
          </span>
          &nbsp; &nbsp; &nbsp;
           <span><img src="<?php echo e(asset('img/ec.png')); ?>" width="50px" style="float: left;"></span>
            &nbsp; &nbsp; &nbsp;
            <span><img src="<?php echo e(asset('img/lc.png')); ?>" width=" 50px" style="float: left;"></span>
            &nbsp; &nbsp; &nbsp;
            <span><img src="<?php echo e(asset('img/ssl.png')); ?>" width="65px" style="float: left; margin-top: -10px;"></span>
             &nbsp; &nbsp; &nbsp;
           <span><img src="<?php echo e(asset('img/mac1.png')); ?>" width="50px" style="float: left;"></span>
            &nbsp; &nbsp; &nbsp;
            

            <!--<span><img src="<?php echo e(asset('img/sl.png')); ?>" width=" 100px" style="float: left;"></span>-->
        ...
        <div class="item row justify-content-between fade-1">
          ...
          <p style="font-size: 10px;">Area of high profit investments always implies having certain risks involved. In most cases laser based product buyers are not responsible for actions of their sellers. It is important to understand that purchasing any digital funds equivalent at Laser Online Platform involves reasonable risks. Your deposit refund is not guaranteed and in some rare cases may even be not returned or lost. Cryptocurrency Trading partially implemented at L.O.P’s Crypto-Capital instrument involves financial risk and may not be appropriate for all investors. The information presented here is for information and educational purposes only and should not be considered an offer or solicitation to buy or sell any financial instrument on Laser Online Platform or elsewhere. Any digital funds purchasing decisions that you make are solely your responsibility. Laser Online Platform instruments include Funds Management Area (Secure Area), Internal Transactions, Bitcoin exchange futures, and economic events. Laser Online Platform R.O.I can be volatile and investors risk losing their investment on any given transaction. However, Laser Online has developed a unique multi-level insuring system where 12% of all deposited funds are transferred to Globalcoast Investment LLC fully operated and controlled Bitcoin Security Fund. This amount is deducted automatically from our profits and does not affect profits of our investors. The only type of risk that should be taken into account is force major that is not linked with bitcoin’ currency rate, namely natural disasters (flood, fire, hurricane etc.). Users involved in harmful activity against Laser Online Platform can get their accounts blocked with no prior notification. Invested money is to be returned to their owners with exception of charges for compensation of damage caused to L.O.P. </p>
           ...
           <p>
            <small>
            &copy; 2017, Globalcoast LLC. All Rights Reserved. <a href="<?php echo e(URL::to('register')); ?>" style="color: white;">Home</a> | <a href="<?php echo e(URL::to('about')); ?>" style="color: white;">About</a> | <a href="<?php echo e(URL::to('faqs')); ?>" style="color: white;">FAQs</a> | <a href="<?php echo e(URL::to('register#contact')); ?>" style="color: white;">Contact </a>| <a href="<?php echo e(URL::to('register#registers')); ?>" style="color: white;">Sign up</a> |<a href="<?php echo e(URL::to('login')); ?>" style="color: white;"> Login</a>
