...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('fonts/opensans/stylesheet.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('fonts/bebas/stylesheet.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('js/vendor/swiper.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('js/vendor/jquery.fullpage.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('js/vegas/vegas.min.css')); ?>">
  ...
  <script src="<?php echo e(asset('js/vendor/modernizr-2.7.1.min.js')); ?>"></script>
      ...
      <nav class="navbar-topmenu">
        ...
        <ul class="navbar-nav navbar-nav-actions">
          <li class="nav-item">
            ...
            <a class="btn btn-outline-white btn-round" href="<?php echo e(route('login')); ?>">
              Login
            </a>
...
function googleTranslateElementInit() {
      ...
      <nav class="navbar-mainmenu">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo e(URL::to('/register')); ?>">
  ...
  <div class="page-cover">
    <!-- Cover Background -->
    <div class="cover-bg bg-img" data-image-src="<?php echo e(asset('img/bg-default1.jpg')); ?>"></div>
...
<script src="<?php echo e(asset('js/jQuerySimpleCounter.js')); ?>"></script>
...
$('#count-test-2').jQuerySimpleCounter({
  ...
  <!-- All vendor scripts -->
  <script src="<?php echo e(asset('js/vendor/all.js')); ?>"></script>
  <script src="<?php echo e(asset('js/particlejs/particles.min.js')); ?>"></script>

  <!-- Countdown script -->
  <script src="<?php echo e(asset('js/jquery.downCount.js')); ?>"></script>

  <!-- Form script -->
  <script src="<?php echo e(asset('js/form_script.js')); ?>"></script>
